...
#define bool int /* FIXME:bool定义 暂用 */
#define false 0
#define true 1
...
void PID_SetOutputLimits(PID *pidp, double, double);
...
void PID_SetControllerDirection(PID *pidp, int);
/* 设置执行PID计算的频率（以毫秒为单位）。 默认值是100 */
void PID_SetSampleTime(PID *pidp, int);
